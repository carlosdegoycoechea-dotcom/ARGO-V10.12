...
class IntelligencePipeline:
    ...
    def execute(
        ...
        # Usar el contexto formateado por CorrectiveRAG con enhanced prompt
        from core.system_prompt import get_enhanced_system_prompt
        system_prompt = get_enhanced_system_prompt(corrected_context.formatted_context)
